...
figure()
plot(gain_target, gain_real, 'g-', label='Measured Gain')
plot(gain_target, gain_target, 'r--', label='Target Gain')
matplotlib.pyplot.ylabel('Measured Gain (dB)')
matplotlib.pyplot.xlabel('Target Gain (dB)')

matplotlib.pyplot.legend()

figure()
distplot(gain_real - gain_pred)
matplotlib.pyplot.xlabel('Gain Error (dB)')
show()
